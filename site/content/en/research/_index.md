...
{{< research-story title="Phase transition and critical phenomena in complex substances" image="/media/research-01.png" width="1600" height="1200" alt="Simulation snapshot illustrating two liquid structures" caption="Illustration accompanying the group's work on liquid-liquid phase transitions." >}}
...
{{< research-story title="Interfacial water structure and dynamics" image="/media/research-02.jpg" width="1395" height="1400" alt="AFM imaging and simulation of an interfacial water molecule" caption="AFM imaging and simulation of interfacial water with a quadrupole-like tip." >}}
...
{{< research-story title="Amorphous solids and non-equilibrium phase transitions" image="/media/research-03.png" width="976" height="472" alt="Three simulation snapshots of confined liquid crystallization" caption="Evolution of a confined liquid in simulation at three successive times." image2="/media/research-04.png" width2="1381" height2="1400" alt2="Eigenvector field in a two-dimensional model glass" caption2="Eigenvector field of vibrational excitations in a two-dimensional model glass." >}}
